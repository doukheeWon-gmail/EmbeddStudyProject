...
#define  ILI9325A   2  /* ILI9325A */
#define  ILI9325C   3  /* 0x9325C */
#define  ILI9328    4  /* 0x9328 */
#define  ILI9331    5  /* 0x9331 */
#define  SSD1298    6  /* 0x8999 */
#define  SSD1289    7  /* 0x8989 */
#define  ST7781     8  /* 0x7783 */
#define  LGDP4531   9  /* 0x4531 */
#define  SPFD5408B  10  /* 0x5408 */
#define  R61505U    11  /* 0x1505 0x0505 */	   
#define  HX8347D    12 /* 0x0047 */
#define  HX8347A    13 /* 0x0047 */	
#define  LGDP4535   14 /* 0x4535 */  
#define  SSD2119    15 /* 3.5 LCD 0x9919 */
...
//	FSMC_NORSRAMInit(&FSMC_NORSRAMInitStructure); 
	...
	/* FSMC写速度设置 */
	FSMC_NORSRAMTimingInitStructure.FSMC_AddressSetupTime = 4;//1;   /* 地址建立时间  */
	FSMC_NORSRAMTimingInitStructure.FSMC_AddressHoldTime = 0;	   
	FSMC_NORSRAMTimingInitStructure.FSMC_DataSetupTime = 35;//1;	   /* 数据建立时间  */
