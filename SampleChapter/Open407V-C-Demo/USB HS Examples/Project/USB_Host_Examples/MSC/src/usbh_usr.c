...
void USBH_USR_EnumerationDone(void)
{
  ...
  LCD_DisplayStringLine( LCD_PIXEL_HEIGHT - 30, "Press WAKEUP KEY...                  ");
...
int USBH_USR_MSC_Application(void)
{
  ...
  case USH_USR_FS_WRITEFILE:
    ...
    LCD_SetTextColor(Green);
    LCD_DisplayStringLine( LCD_PIXEL_HEIGHT - 42, "                                              ");
    LCD_DisplayStringLine( LCD_PIXEL_HEIGHT - 30, "Press WAKEUP KEY to write file");
    LCD_SetTextColor(LCD_LOG_DEFAULT_COLOR); 
    ...
    LCD_SetTextColor(Green);
    LCD_DisplayStringLine( LCD_PIXEL_HEIGHT - 42, "                                              ");
    LCD_DisplayStringLine( LCD_PIXEL_HEIGHT - 30, "To start Image slide show Press WAKEUP KEY.");
    LCD_SetTextColor(LCD_LOG_DEFAULT_COLOR); 
  ...
  if (res == FR_OK) {
    while(HCD_IsDeviceConnected(&USB_OTG_Core)) 
    {
      ...
      if(line_idx > 9)
      {
        ...
        LCD_SetTextColor(Green);
        LCD_DisplayStringLine( LCD_PIXEL_HEIGHT - 42, "                                              ");
        LCD_DisplayStringLine( LCD_PIXEL_HEIGHT - 30, "Press WAKEUP KEY to continue...");
        LCD_SetTextColor(LCD_LOG_DEFAULT_COLOR); 
